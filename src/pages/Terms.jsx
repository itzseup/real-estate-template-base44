  ...
  return (
    <div className="min-h-screen bg-white py-24 md:py-40 px-[4%] md:px-[2%] font-body">
      <Seo
        ...
        description="City Walk Real Estate LLC Terms of Service governing the use of our UAE real estate services."
        url="/terms"
        schema={breadcrumbSchema([
          { name: "Home", url: "https://citywalkrealestatellc.com" },
          { name: "Terms of Service", url: "https://citywalkrealestatellc.com/terms" },
        ])}
      />
      <div className="max-w-[800px] mx-auto">
        ...
        <div className="prose prose-lg max-w-none">
          <p>© 2024 City Walk Real Estate LLC. All rights reserved.</p>
          
          <h2 className="font-display text-xl font-light mb-4 mt-8">1. Acceptance of Terms</h2>
          <p>
            By accessing or using the City Walk Real Estate LLC website and services, you agree to be bound 
          ...
          <p>
            City Walk Real Estate LLC provides real estate listing, buyer representation, seller advisory, 
          ...
          <p>
            To the maximum extent permitted by law, City Walk Real Estate LLC and its affiliates shall not be 
